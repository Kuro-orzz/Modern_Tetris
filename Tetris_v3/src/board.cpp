...
//    SDL_RenderCopy( getRenderer(), getTexture(), NULL, NULL);
    ...
    SDL_Rect pos1 = {275, 100, 350, 700};
    SDL_RenderFillRect(getRenderer(), &pos1);
    SDL_Rect pos2 = {600, 100, 205, 540};
    SDL_RenderFillRect(getRenderer(), &pos2);
    pos2 = {600, 640, 205, 1};
    for(int i = 0; i < 13; i++){
        pos2.w--;
        pos2.h++;
    ...
    SDL_Rect pos3 = {100, 100, 200, 120};
    SDL_RenderFillRect(getRenderer(), &pos3);
    pos3 = {100, 220, 200, 3};
    for(int i = 0; i < 10; i++){
        pos3.x++;
        pos3.w--;
